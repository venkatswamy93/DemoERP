...
const styles = StyleSheet.create({
  ...
  table: { display: 'table', width: '100%', border: '1 solid black', marginTop: 10 },
  tableRow: { flexDirection: 'row', borderBottom: '1 solid black' },
  tableCell: { flex: 1, padding: 5, fontSize: 10, borderRight: '1 solid black' },
  summaryTable: { marginTop: 20, width: '100%', border: '1 solid black' },
  summaryTableRow: { flexDirection: 'row', borderBottom: '1 solid black' },
  summaryTableCell: { padding: 5, fontSize: 12, flex: 1, textAlign: 'center', borderRight: '1 solid black' },
  footer: { marginTop: 20, textAlign: 'center', fontSize: 10, borderTop: '1 solid black', paddingTop: 5 },
});
